 ...
 */
enum {LED_FLASH, LED1_FLASH, LED2_FLASH, COMMS_TALK_TASK};
...
/* Comms tasks */
void comms_talk_task (void* data)
{
	i2c_ret_t ret;
	i2c_addr_t addr;
	ret = i2c_slave_read(i2c_camera, buffer, 1, IBP_I2C_TIMEOUT);
...
main ()
{
        ...
        kernel_taskRegister(comms_talk_task, COMMS_TALK_TASK, &comms_data, 20);
